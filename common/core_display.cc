...
static const unsigned char bigchars[131][5] =
    {
...
static int ext_misc_cat[] = {
    ...
    CMD_GETLI,  CMD_GETMI,   CMD_HEIGHT, CMD_LOCK,     CMD_MIXED,       CMD_PCOMPLX,
    CMD_PRREG,  CMD_PUTLI,   CMD_PUTMI,  CMD_RCOMPLX,  CMD_STRACE,      CMD_UNLOCK,
